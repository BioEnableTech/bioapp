...
'Use Strict';
angular.module('App').controller('profileController', function($scope, $state, $localStorage, Utils, $ionicSideMenuDelegate, Popup, $timeout, Service, $ionicTabsDelegate, $ionicHistory, Watchers) {
