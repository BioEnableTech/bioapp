...
'Use Strict';
angular.module('App').controller('messagesController', function($scope, $rootScope, $state, $localStorage, $ionicSideMenuDelegate, Popup, Utils, $filter, Watchers, $timeout, $ionicPlatform, Service, $window, $stateParams, $ionicTabsDelegate, $ionicHistory) {
