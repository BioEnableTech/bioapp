...
'Use Strict';
angular.module('App').controller('friendsController', function($scope, $state, $localStorage, Popup, $timeout, Utils, Watchers, Service, $ionicTabsDelegate, $ionicHistory,$ionicSideMenuDelegate) {
