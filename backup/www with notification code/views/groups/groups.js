...
'Use Strict';
angular.module('App').controller('groupsController', function($scope, $state, $localStorage, $ionicSideMenuDelegate, Utils, Popup, $timeout, Service, $ionicTabsDelegate, $ionicHistory) {
