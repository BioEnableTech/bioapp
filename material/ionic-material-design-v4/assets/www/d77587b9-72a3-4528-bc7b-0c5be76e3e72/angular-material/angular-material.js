...
var db = null; window.globalVariable = { color: { appPrimaryColor: "", dropboxColor: "#017EE6", facebookColor: "#3C5C99", foursquareColor: "#F94777", googlePlusColor: "#D73D32", instagramColor: "#517FA4", wordpressColor: "#0087BE" }, startPage: { url: "/app/dashboard", state: "app.dashboard" }, message: { errorMessage: "Technical error please try again later." }, oAuth: { dropbox: "", facebook: "", foursquare: "", instagram: "", googlePlus: "" }, adMob: "" }; angular.module("starter", ["ionic", "ngIOS9UIWebViewPatch", "starter.controllers", "starter.services", "ngMaterial", "ngMessages", "ngCordova"]).run(["$ionicPlatform", "$cordovaSQLite", "$rootScope", "$ionicHistory", "$state", "$mdDialog", "$mdBottomSheet", function (n, t, i, r, u, f, e) { function h() { db = window.cordova ? t.openDB("contract.db") : window.openDatabase("contract.db", "1.0", "IonicMaterialDesignDB", -1); t.execute(db, "CREATE TABLE IF NOT EXISTS contracts ( id           integer primary key   ,   firstName    text                  ,   lastName     text                  ,   telephone    text                  ,   email        text                  ,   note         text                  ,   createDate   dateTime              ,   age          integer               ,   isEnable     Boolean)                ") } function c() { return ".material-background-nav-bar {    background-color        : " + appPrimaryColor + " !important;    border-style            : none;}.md-primary-color {   color                     : " + appPrimaryColor + " !important;}" } function l() { return ".material-background-nav-bar {    background-color        : " + appPrimaryColor + " !important;   border-style            : none;   background-image        : url('img/background_cover_pixels.png') !important;   background-size         : initial !important;}.md-primary-color {   color                     : " + appPrimaryColor + " !important;}" } function a() { return ".material-background-nav-bar {    background-color        : transparent !important;   border-style            : none;   background-image        : none !important;   background-position-y   : 4px !important;   background-size         : initial !important;}.md-primary-color {   color                     : " + appPrimaryColor + " !important;}" } function o(n) { return ".material-background-nav-bar {   background              : " + n + " !important;   border-style            : none;} md-ink-bar {   color                   : " + n + " !important;   background              : " + n + " !important;}md-tab-item {   color                   : " + n + " !important;} md-progress-circular.md-warn .md-inner .md-left .md-half-circle {   border-left-color       : " + n + " !important;} md-progress-circular.md-warn .md-inner .md-left .md-half-circle, md-progress-circular.md-warn .md-inner .md-right .md-half-circle {    border-top-color       : " + n + " !important;} md-progress-circular.md-warn .md-inner .md-gap {   border-top-color        : " + n + " !important;   border-bottom-color     : " + n + " !important;}md-progress-circular.md-warn .md-inner .md-right .md-half-circle {  border-right-color       : " + n + " !important; }.spinner-android {   stroke                  : " + n + " !important;}.md-primary-color {   color                   : " + n + " !important;}a.md-button.md-primary, .md-button.md-primary {   color                   : " + n + " !important;}" } function v() { i.appPrimaryColor = appPrimaryColor; i.isAndroid = ionic.Platform.isAndroid(); i.isIOS = ionic.Platform.isIOS() } function y() { e.cancel(); f.cancel() } function s(n) { var t = ".material-background {   background-color          : " + appPrimaryColor + " !important;   border-style              : none;}.spinner-android {   stroke                    : " + appPrimaryColor + " !important;}"; switch (n) { case "app.productList": case "app.productDetail": case "app.productCheckout": case "app.clothShop": case "app.catalog": t += l(); break; case "app.dropboxLogin": case "app.dropboxProfile": case "app.dropboxFeed": t += o(window.globalVariable.color.dropboxColor); break; case "app.facebookLogin": case "app.facebookProfile": case "app.facebookFeed": case "app.facebookFriendList": t += o(window.globalVariable.color.facebookColor); break; case "app.foursquareLogin": case "app.foursquareProfile": case "app.foursquareFeed": t += o(window.globalVariable.color.foursquareColor); break; case "app.googlePlusLogin": case "app.googlePlusProfile": case "app.googlePlusFeed": t += o(window.globalVariable.color.googlePlusColor); break; case "app.instagramLogin": case "app.instagramProfile": case "app.instagramFeed": t += o(window.globalVariable.color.instagramColor); break; case "app.wordpressLogin": case "app.wordpressFeed": case "app.wordpressPost": t += o(window.globalVariable.color.wordpressColor); break; case "app.contractUs": t += a(); break; default: t += c() } return t } i.customStyle = s(window.globalVariable.startPage.state); n.ready(function () { ionic.Platform.isFullScreen = !0; window.cordova && window.cordova.plugins.Keyboard && (cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0), cordova.plugins.Keyboard.disableScroll(!0)); window.StatusBar && StatusBar.styleDefault(); h(); v(); i.$on("$ionicView.beforeEnter", function () { y(); i.customStyle = s(r.currentStateName()) }) }) }]).config(["$ionicConfigProvider", "$stateProvider", "$urlRouterProvider", "$mdThemingProvider", "$mdIconProvider", "$mdColorPalette", "$mdIconProvider", function (n, t, i, r, u, f, u) { n.spinner.icon("android"); n.views.swipeBackEnabled(!1); u.icon("facebook", "img/icons/facebook.svg").icon("twitter", "img/icons/twitter.svg").icon("mail", "img/icons/mail.svg").icon("message", "img/icons/message.svg").icon("share-arrow", "img/icons/share-arrow.svg").icon("more", "img/icons/more_vert.svg"); r.theme("default").primaryPalette("pink").accentPalette("red"); appPrimaryColor = f[r._THEMES.default.colors.primary.name]["500"]; t.state("app", { url: "/app", abstract: !0, templateUrl: "c596fdc8-ae7f-47a1-b081-7a756f9bac94.html", controller: "f029f552-a944-4c58-9e04-75c66b7f707b" }).state("app.dashboard", { url: "/dashboard", params: { isAnimated: !1 }, views: { menuContent: { templateUrl: "d4bdcc3f-4609-49e3-ae12-55f2542c3bff.html", controller: "8951bfcc-ef73-41f3-b4e9-96360632c510" } } }).state("app.dashboardSetting", { url: "/dashboardSetting", views: { menuContent: { templateUrl: "b7703730-41a9-43a6-83a8-5de0772ebf59.html", controller: "b94b9e90-c392-484d-8f44-0dad5fe029a9" } } }).state("app.contractlist", { url: "/contractlist", cache: !1, params: { isAnimated: ionic.Platform.isAndroid() == !1 }, views: { menuContent: { templateUrl: "154ac94e-d4cc-4ccc-9565-d0c65d17f4d9.html", controller: "e3197b5b-b85e-407a-9176-ea3f2454cd0e" } } }).state("app.contractdetail", { url: "/contractdetail", params: { contractdetail: null, actionDelete: !1 }, views: { menuContent: { templateUrl: "f361ad6e-45f2-438c-b75a-6c6cbedfbac4.html", controller: "fe4e3363-bffe-456c-bd06-82cef9f71518" } } }).state("app.contractsetting", { url: "/contractsetting", cache: !1, views: { menuContent: { templateUrl: "90a854f3-7ae2-4819-9108-32d77d3db130.html", controller: "826e1964-9c63-494c-953e-b8281e443070" } } }).state("app.notelist", { url: "/notelist", params: { isAnimated: !1 }, cache: !1, views: { menuContent: { templateUrl: "96bf7f5b-45b9-4e41-bb56-e883db3cf2ce.html", controller: "64b6307d-c0be-41cd-b1a0-fef0c62a287b" } } }).state("app.notedetail", { url: "/notedetail", params: { noteDetail: null, actionDelete: !1 }, views: { menuContent: { templateUrl: "4129c91c-9372-4db6-b944-e6f8154c6bf8.html", controller: "0327eb72-a997-4dd8-bc8b-72ec5b4bb6bb" } } }).state("app.notesetting", { url: "/notesetting", views: { menuContent: { templateUrl: "8dd6195a-4ac7-4acd-8aed-2ceef2f2c943.html", controller: "a2f52912-ab9b-4f09-a6d3-ed5b5ac05503" } } }).state("app.facebookLogin", { url: "/facebookLogin", cache: !1, views: { menuContent: { templateUrl: "3ed18a87-00de-47be-b3a5-eb52091f71f0.html", controller: "c67e5ba1-80a5-42a4-ab21-63b82ccffcdd" } } }).state("app.facebookProfile", { url: "/facebookProfile", cache: !1, views: { menuContent: { templateUrl: "d4ef01a2-3893-4023-a506-24682f152d1b.html", controller: "8edbbc62-8e69-4d32-a99a-684d8dc67e85" } } }).state("app.facebookFeed", { url: "/facebookFeed", cache: !1, views: { menuContent: { templateUrl: "4a77385f-528b-470b-b580-1805d2cccb52.html", controller: "bcf399e9-a822-42c7-825b-8477c2ea2856" } } }).state("app.facebookFriendList", { url: "/facebookFriendList", cache: !1, params: { access_token: null }, views: { menuContent: { templateUrl: "4b82b092-ae76-40ca-a6ed-d05edb74f802.html", controller: "90e1e5d1-2bb4-4bdb-b3ba-a2f43f556351" } } }).state("app.googlePlusLogin", { url: "/googlePlusLogin", cache: !1, views: { menuContent: { templateUrl: "df8507f2-a4de-4b65-9688-777f71e6aac6.html", controller: "fdef8928-cacc-4630-8998-bc7e1668df6d" } } }).state("app.googlePlusProfile", { url: "/googlePlusProfile", cache: !1, views: { menuContent: { templateUrl: "e7b7e272-ab5d-4e2a-9484-f84393d0c70f.html", controller: "22423266-b3f6-42ea-b684-964980e734ed" } } }).state("app.googlePlusFeed", { url: "/googlePlusFeed", cache: !1, views: { menuContent: { templateUrl: "f47b0899-002d-4718-a803-43647a150663.html", controller: "8ecd40b5-321a-48d5-9114-7afb3d8b0917" } } }).state("app.instagramLogin", { url: "/instagramLogin", cache: !1, views: { menuContent: { templateUrl: "9dd35e8a-d4bf-402e-892c-49769ab8a98a.html", controller: "a34930d4-51de-4c85-b7eb-3de12766a92e" } } }).state("app.instagramProfile", { url: "/instagramProfile", cache: !1, views: { menuContent: { templateUrl: "f5d6e253-a58b-41cf-9248-269a16ad979b.html", controller: "dd51f180-01a2-4f0e-988f-3eafd693f85d" } } }).state("app.instagramFeed", { url: "/instagramFeed", cache: !1, views: { menuContent: { templateUrl: "fff24efa-2429-473d-a47e-076aca5c83f6.html", controller: "12c07aaa-6eb4-4ec1-9ead-c1d4952ccdae" } } }).state("app.foursquareLogin", { url: "/foursquareLogin", cache: !1, views: { menuContent: { templateUrl: "05ddd0f1-f90c-4d60-893d-d11462443316.html", controller: "fe5ec56e-757d-4251-8fa8-2e003bf997ab" } } }).state("app.foursquareProfile", { url: "/foursquareProfile", cache: !1, views: { menuContent: { templateUrl: "0eeeecf5-24fa-44a1-b6c0-00f3c1f357ef.html", controller: "f94e243c-08b4-4e7f-9a44-1872ff317b54" } } }).state("app.foursquareFeed", { url: "/foursquareFeed", cache: !1, views: { menuContent: { templateUrl: "4db62b5a-07a8-4aba-9527-b9520f1fe721.html", controller: "df134744-b9eb-480c-8207-5d6cfcf2ec55" } } }).state("app.dropboxLogin", { url: "/dropboxLogin", cache: !1, views: { menuContent: { templateUrl: "c90a77d6-fb9c-4d1a-93ed-bfb90462acc8.html", controller: "87771b8d-36c8-4712-80c8-5ecd4d7ef3d9" } } }).state("app.dropboxProfile", { url: "/dropboxProfile", cache: !1, views: { menuContent: { templateUrl: "5b27cbbb-b7ca-4312-819e-ae5e8c940797.html", controller: "f8357d03-ad91-44cc-aa9c-350a8da5c41c" } } }).state("app.dropboxFeed", { url: "/dropboxFeed", cache: !1, views: { menuContent: { templateUrl: "0ced7d56-c958-4cda-afef-be7e2ef4ae46.html", controller: "d88aff6e-19fe-44f7-9af4-79e7c7396cc4" } } }).state("app.fakeLogin", { url: "/fakeLogin", cache: !1, views: { menuContent: { templateUrl: "30694341-fe65-48a9-b51c-2a182ae2650a.html" } } }).state("app.fakeSignUp", { url: "/fakeSignUp", cache: !1, views: { menuContent: { templateUrl: "9e45e6ab-ad0e-415a-93bb-de04521105d8.html" } } }).state("app.productList", { url: "/productList", views: { menuContent: { templateUrl: "205bfa05-7a67-4b91-8c55-aae0ddd527f7.html", controller: "d8e35bbd-8dd5-4324-a6c2-8f6885e45ff7" } } }).state("app.productDetail", { url: "/productDetail", params: { product: null }, views: { menuContent: { templateUrl: "e602d185-b270-457b-b455-9288201dbc33.html", controller: "4102b4dd-c8c2-491f-be97-db63f3789be0" } } }).state("app.productCheckout", { url: "/productCheckout", views: { menuContent: { templateUrl: "9366b7ba-61ff-4250-8777-8fdf6ded5fe0.html", controller: "761d1f02-44ff-4440-889e-530d98bc67f6" } } }).state("app.contractUs", { url: "/contractUs", views: { menuContent: { templateUrl: "56a54b5e-6639-4857-964c-480edb934f48.html", controller: "b77ec184-6ac2-40f4-bc0b-7353de2b734f" } } }).state("app.deviceInformation", { url: "/deviceInformation", views: { menuContent: { templateUrl: "3d127acd-aca9-4925-ad42-6e0f95b8037c.html", controller: "70df862e-2343-44c0-9391-8d425a2c0390" } } }).state("app.mobileContractList", { url: "/mobileContractList", cache: !1, views: { menuContent: { templateUrl: "9d1a7b32-5992-47d6-8e3f-c58b003c4540.html", controller: "aa1e2471-5720-467b-837c-4f67af8117a9" } } }).state("app.mobileContractDetail", { url: "/mobileContractDetail", params: { contractDetail: null, actionDelete: !1 }, views: { menuContent: { templateUrl: "2a3726a8-ef6b-44bf-a66c-a9369fb3be59.html", controller: "c676ddf4-5335-4122-bc8f-2048ac41c326" } } }).state("app.flashLight", { url: "/flashLight", views: { menuContent: { templateUrl: "832dc46e-4233-483d-b01b-5e9f7c6f5577.html", controller: "1e68c577-259b-4f7e-a72b-98aca68ca576" } } }).state("app.vibration", { url: "/vibration", views: { menuContent: { templateUrl: "0b54c069-48d6-4931-b076-d21d58d4e185.html", controller: "668b46c5-adfe-494d-9001-09da2c312e47" } } }).state("app.googleAdmob", { url: "/googleAdmob", views: { menuContent: { templateUrl: "9aa60d88-9251-4b1e-8a42-0af242fddee9.html", controller: "ab110ead-ee31-4a71-9bea-95ffd8585b80" } } }).state("app.imagePicker", { url: "/imagePicker", cache: !1, views: { menuContent: { templateUrl: "c5a8581f-f0dd-4eab-aa21-5ff1299d7f2b.html", controller: "ade41166-fc50-4039-bb4f-6b72e536b54a" } } }).state("app.wordpressFeed", { url: "/wordpressFeed", params: { wordpressUrl: null }, views: { menuContent: { templateUrl: "48b282f6-94f5-480f-ae3b-18750044ad14.html", controller: "eb935ac2-d49a-4d96-9420-ae1a5be4858c" } } }).state("app.wordpressLogin", { url: "/wordpressLogin", cache: !1, params: { isShowError: !1 }, views: { menuContent: { templateUrl: "7503d608-bcd1-48f6-819e-bce1c768e95b.html", controller: "f81b4166-242c-4d54-95c0-d46c296a9386" } } }).state("app.wordpressPost", { url: "/wordpressPost", cache: !1, params: { postDetail: null, wordpressUrl: null }, views: { menuContent: { templateUrl: "cf659442-dee4-48d6-b402-1a57a453b442.html", controller: "9505c9ce-cf4c-4d18-9db8-a4827a4efb06" } } }).state("app.defaultUI", { url: "/defaultUI", cache: !1, views: { menuContent: { templateUrl: "55fd6fa0-7076-4359-9305-1bbd78bb294e.html", controller: "3e7f5b39-e262-4b80-a3f9-562389cceadd" } } }).state("app.tryApp", { url: "/tryApp", cache: !1, views: { menuContent: { templateUrl: "5d41b7cc-8421-441b-9cb3-ea02de78b9a5.html" } } }).state("app.tryAppNoBackBtn", { url: "/tryAppNoBackBtn", cache: !1, views: { menuContent: { templateUrl: "9850d4fd-5586-46ba-abe8-680f23560ca0.html" } } }).state("app.pricing", { url: "/pricing", views: { menuContent: { templateUrl: "9f9622dc-aecb-48b9-ac46-0aa0de392b2f.html" } } }).state("app.menuDashboard", { url: "/menuDashboard", views: { menuContent: { templateUrl: "ba2ca7af-3b71-4d26-acfe-76714d195fce.html", controller: "113638b3-361e-4fb5-a042-6f2da2b2a91b" } } }).state("app.expense", { url: "/expense", params: { isAnimated: !0 }, views: { menuContent: { templateUrl: "c147477c-613d-4d8d-9368-745bc0f29c0b.html", controller: "46a2bfcb-3c8c-4369-bb85-1763c0b7e028" } } }).state("app.expenseSetting", { url: "/expenseSetting", views: { menuContent: { templateUrl: "840d598b-31e2-4821-bd7d-eb56777f87e0.html", controller: "657a595d-411f-434e-8c74-7046c213a870" } } }).state("app.newsFeed", { url: "/newsFeed", views: { menuContent: { templateUrl: "7b07f5cd-ccd0-4411-8503-237f08406520.html" } } }).state("app.clothShop", { url: "/clothShop", views: { menuContent: { templateUrl: "5ffaab31-35b1-4b0d-bc4d-1b342b8c2d24.html" } } }).state("app.onlineCourse", { url: "/onlineCourse", views: { menuContent: { templateUrl: "2c6f27df-c70f-432b-8a80-3c02169da9e2.html" } } }).state("app.catalog", { url: "/catalog", views: { menuContent: { templateUrl: "fb6455d6-637d-4a6d-ac77-75f587867207.html", controller: "53799595-e529-47b7-bb12-6f09d9cbf531" } } }).state("app.locationFeed", { url: "/locationFeed", views: { menuContent: { templateUrl: "a4e1757c-2b0a-45ad-a3d8-2e98c06b9588.html" } } }).state("app.cubeFeed", { url: "/cubeFeed", views: { menuContent: { templateUrl: "b9794f0c-f134-4a17-ba0c-d610b2757109.html" } } }).state("app.restaurant", { url: "/restaurant", views: { menuContent: { templateUrl: "d5de3adf-1d7d-48b4-8ec5-7c0c04541afd.html" } } }).state("app.singlePushNotification", { url: "/singlePushNotification", views: { menuContent: { templateUrl: "caf8d5c5-2318-458d-b836-c38af3472f71v.html", controller: "8b026b89-91dd-4e30-b9d2-ed5c827b4792" } } }).state("app.schedulePushNotification", { url: "/schedulePushNotification", views: { menuContent: { templateUrl: "bdcc74eb-fd02-4fa6-8f30-eeec83e13f20.html", controller: "e5a57382-691f-4b0d-b360-fe08727565cb" } } }).state("app.iosMapConnect", { url: "/iosMapConnect", views: { menuContent: { templateUrl: "90626f44-3f9f-4590-9d19-a938a1c995d5.html", controller: "cc763c47-5a81-4960-860a-fbafe16cee8b" } } }).state("app.androidMapConnect", { url: "/androidMapConnect", views: { menuContent: { templateUrl: "1b0ddc7f-3b3c-4581-89b5-165d77edf2d5.html", controller: "f921c15f-5cf6-4044-a30d-16a29745e7ef" } } }); i.otherwise(window.globalVariable.startPage.url) }]);
var appServiceCore = angular.module("starter.service.core", []);